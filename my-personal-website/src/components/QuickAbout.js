  ...
  return (
    <section className="quick-about">
      ...
      <p className="font-bold">
        ...
        <a href="https://www.niche.com/colleges/rice-university/" target="_blank" rel="noreferrer" className="no-underline hover:underline decoration-indigo-500" style={{ color: 'white' }}>
          Rice University
        </a> 
      </p>
